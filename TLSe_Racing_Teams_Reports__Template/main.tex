...
\section{\textcolor{red}{Rules and Regulations from formula student 2025 rules }}
...
\begin{itemize}
    \item Are we obliged to simulate the bolts in the contact between the bottom surface and the module?
...
Change the container design to simulate the actual contact between the module and the bottom surface. The part of the module that will be in contact with the container’s bottom surface consists of two thin, wide surfaces, which can be modeled as two lines representing the contact between the module and the bottom surface.

Also, integrate the container into the vehicle model and run a realistic simulation with the car to observe the behavior and see what happens.
